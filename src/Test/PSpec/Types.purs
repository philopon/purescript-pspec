...
type SpecWriter e a = {a :: a, w :: List (Operation e)}
...
instance functorSpec :: Functor (Spec e) where
  map f (Spec w) = Spec (w { a = f w.a })

instance applySpec :: Apply (Spec e) where
  apply (Spec f) (Spec a) = Spec { a : f.a a.a, w : f.w ++ a.w }

instance applicativeSpec :: Applicative (Spec e) where
  pure a = Spec {a: a, w: Nil}
...
write o = Spec {a: unit, w: Cons o Nil}
